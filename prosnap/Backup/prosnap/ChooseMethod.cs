     ...
     //   Boolean bthbox = true;
      ...
      //  ServiceHost Shost;
        ...
        String[] callvertical(int emb, String imagelocat)
        {
            ...
            sFileName_save = sFileName_save.Substring(sFileName_save.LastIndexOf('\\'));
            ...
            files[3] = files[3].Substring(files[3].LastIndexOf('\\'));
        ...
        String[] callhorizontal(int emb, string imagelocat)
        {
            ...
            files[4] = files[4].Substring(files[4].LastIndexOf('\\'));
        ...
        String[] callbox(int emb, string imagelocat)
        {
            ...
            files[2] = files[2].Substring(files[2].LastIndexOf('\\'));
